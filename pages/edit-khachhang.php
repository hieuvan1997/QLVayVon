...
if (isset($_POST['save-kh'])) {
	...
	$tenkhachhang = mysqli_real_escape_string($con, $_POST['ten_khachhang']);
	...
	$sql = "UPDATE khachhang 
					SET ten_khachhang='$ten_khachhang',diachi='$diachi',nghenghiep='$nghenghiep',gioitinh='$gioitinh',mucthunhap='$mucthunhap',mucdenghivay='$mucdenghivay',mucdich='$mucdich',mucvayduocduyet='$mucvayduocduyet',macdcs='$macdcs'
					 WHERE makh='$makh'";
	mysqli_query($con, $sql);
	header('location: ../data/test3.php');
}
...
$thoigianvay = $data['thoigianvay'];
$ngayvay = $data['ngayvay'];
$macdcs = $data['macdcs'];
?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							...
							<div class="header">
								...
								<h3>Sửa dữ liệu khách hàng: <br><?php echo "$ten_khachhang"; ?></h3>
								...
								<form class="modal-content animate" method="post" action="edit-khachhang.php">
									...
									<form method="post" action="edit-khachhang.php">
										...
										<div>
											...
											<input id="ten" type="text" name="ten_khachhang" value="<?php echo "$ten_khachhang" ?>">
										...
										<div>
											...
											<input id="l3" type="text" name="thoigianvay" value="<?php echo "$thoigianvay" ?>">
										</div>
										<div>
											<label class="label">Ngày bắt đầu vay:</label>
											<input id="l1" type="text" name="ngayvay" value="<?php echo "$ngayvay" ?>">
										</div>

										<div class="container">
											<button class="btn" type="submit" name="save-kh">Lưu</button>

											<a href="test3.php"><button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn">Hủy</button></a>
											</button>
										</div>
