...
if (isset($_POST['save'])) {
	...
	$sql = "UPDATE cdct SET ten_cdct='$ten_cdct',diachi='$diachi',sdt='$sdt',email='$email' WHERE macdct='$macdct'";
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							...
							<div class="header">
								...
								<h3>Sửa dữ liệu CĐCT: <br><?php echo "$ten_cdct"; ?></h3>
							...
							<div id="id01" class="modal">
								...
								<form class="modal-content animate" method="post" action="edit-cdct.php">
									...
									<div>
										<label class="label">Tên CĐCT:</label>
										<input type="text" name="ten_cdct" value="<?php echo "$ten_cdct" ?>">
									</div>
									<div>
									...
									<div class="container">
										<button class="btn" type="submit" name="save">Lưu</button>

										<a href="test.php"><button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn">Hủy</button></a>
										</button>
									</div>
